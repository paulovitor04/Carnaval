<template>
    <div id="body">
        <h2 class="titulos"> 
            <tbody>
                <h1>{{ listaEscolas[1].name }}</h1>
            </tbody>          
        </h2>
        <img :src="listaEscolas[1].photo" width="35%"> 
    <div class="conteudo">
        <h2 class="titulos"> História </h2>        
            <p class="informacoes" >
                {{listaEscolas[1].description}}
            </p>
        <h2 class="titulos"> Próximas datas </h2>
         ...
         <div class="comentarios">
            <div class="usuario">
                <div class="foto">
                    <figure>
                    <img src="https://upload.wikimedia.org/wikipedia/pt/b/bd/Logotipo_Il%C3%AA_Aiy%C3%AA.png">
                    </figure>
                </div>
