<template>
    <div id="body">
        <h2 class="titulos"> 
            <tbody>
                <h1>{{ listaEscolas[3].name }}</h1>
            </tbody>          
        </h2>
        <img :src="listaEscolas[3].photo" width="35%">  
    <div class="conteudo">
        <h2 class="titulos"> História </h2>        
            <p class="informacoes" >
                {{listaEscolas[3].description}}
            </p>
        <h2 class="titulos"> Próximas datas </h2>
         ...
         <div class="comentarios">
            <div class="usuario">
                <div class="foto">
                    <figure>
                    <img src="https://live.staticflickr.com/7057/6911281587_d2e9bfae0f_n.jpg">
                    </figure>
                </div>
