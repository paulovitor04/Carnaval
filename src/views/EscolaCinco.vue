<template>
    <div id="body">
        <h2 class="titulos"> 
            <tbody>
                <h1>{{ listaEscolas[5].name }}</h1>
            </tbody>          
        </h2>
        <img :src="listaEscolas[5].photo" width="35%">  
    <div class="conteudo">
        <h2 class="titulos"> História </h2>        
            <p class="informacoes" >
                {{listaEscolas[5].description}}
            </p>
        <h2 class="titulos"> Próximas datas </h2>
         ...
         <div class="comentarios">
            <div class="usuario">
                <div class="foto">
                    <figure>
                    <img src="https://s2.glbimg.com/EFvmkr0asp-HUlh1011ru-RZ7DY=/0x0:5184x3456/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_59edd422c0c84a879bd37670ae4f538a/internal_photos/bs/2018/L/2/OOFKa1TNyUBYoCSjKwkQ/homem-meianoite.jpg">
                    </figure>
                </div>
...
<style scoped>
 @import url('https://fonts.googleapis.com/css2?family=Inconsolata&family=Titillium+Web&display=swap');
#body {
    margin: 30px;
}
h1 {
