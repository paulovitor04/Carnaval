<template>
    <div id="body">
        <h2 class="titulos"> 
            <tbody>
                <h1>{{ listaEscolas[4].name }}</h1>
            </tbody>          
        </h2>
        <img :src="listaEscolas[4].photo" width="35%">  
    <div class="conteudo">
        <h2 class="titulos"> História </h2>        
            <p class="informacoes" >
                {{listaEscolas[4].description}}
            </p>
        <h2 class="titulos"> Próximas datas </h2>
         ...
         <div class="comentarios">
            <div class="usuario">
                <div class="foto">
                    <figure>
                    <img src="https://home.centraldocarnaval.com.br/midia/arquivo01Blocos/183e72cd1134762a7325f528fee96ac5.jpg">
                    </figure>
                </div>
